  ...
  MASE.errorRecovery = {
    ...
    setupNetworkMonitoring: function () {
      ...
      window.addEventListener('offline', function () {
        ...
        self.showNotice(
          'Network connection lost. Changes will be saved when connection is restored.',
          'warning',
        );
      });
    },
    ...
    retryOperation: function (operation, options) {
      ...
      const operationId = options.operationId || 'operation_' + Date.now();
    ...
    uploadWithRetry: function (file, options) {
      ...
      const area = options.area || 'dashboard';
      ...
      const uploadOperation = function () {
        return new Promise(function (resolve, reject) {
          ...
          $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
              const errorMessage = self.getAjaxErrorMessage(jqXHR, textStatus, errorThrown);
              reject({
