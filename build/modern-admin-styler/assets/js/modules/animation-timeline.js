...
class Keyframe {
  ...
  update(updates) {
    ...
    if (updates.properties !== undefined) {
      this.properties = { ...updates.properties };
    }
    if (updates.easing !== undefined) {
      this.easing = updates.easing;
    }
  }
  ...
  _updatePropertiesPanel() {
    if (!this.selectedKeyframe || !this.selectedTrack) {
      this.propertiesPanel.innerHTML =
        '<div class="mase-timeline-properties-empty">Select a keyframe to edit</div>';
      return;
    }
    ...
    this.propertiesPanel.querySelector('.mase-kf-time').oninput = (e) => {
      this.timeline.updateKeyframe(this.selectedTrack.id, kf.id, {
