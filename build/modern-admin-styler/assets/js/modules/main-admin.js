...
export class MASEAdmin {
  ...
  _attachTabListeners() {
    ...
    if (typographyTab) {
      typographyTab.addEventListener(
        'click',
        async () => {
  ...
  try {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (window.maseAdmin?.debug) {
        ...
        console.log(
          'MASE: Debug mode enabled - instance available as window.maseAdmin and window.maseModern',
        );
      }
    }
