...
<div class="mase-backgrounds-wrapper">
	...
	<div class="mase-backgrounds-accordion">
		<?php
		foreach ( $admin_areas as $area_id => $area_config ) :
							...
							<div class="mase-setting-control">
								...
								<div class="mase-position-picker-grid" data-area="<?php echo esc_attr( $area_id ); ?>">
									...
									$grid_positions   = array(
										array(
											'value' => 'left top',
											'label' => __( 'Top Left', 'modern-admin-styler' ),
										),
										array(
											'value' => 'center top',
											'label' => __( 'Top Center', 'modern-admin-styler' ),
										),
										array(
											'value' => 'right top',
											'label' => __( 'Top Right', 'modern-admin-styler' ),
										),
										array(
											'value' => 'left center',
											'label' => __( 'Center Left', 'modern-admin-styler' ),
										),
										array(
											'value' => 'center center',
											'label' => __( 'Center', 'modern-admin-styler' ),
										),
										array(
											'value' => 'right center',
											'label' => __( 'Center Right', 'modern-admin-styler' ),
										),
										array(
											'value' => 'left bottom',
											'label' => __( 'Bottom Left', 'modern-admin-styler' ),
										),
										array(
											'value' => 'center bottom',
											'label' => __( 'Bottom Center', 'modern-admin-styler' ),
										),
										array(
											'value' => 'right bottom',
											'label' => __( 'Bottom Right', 'modern-admin-styler' ),
										),
									);
