...
(function($) {
	...
	MASE.assetLoader = {
		...
		initDOMCache: function() {
			...
			console.log('MASE: DOM cache initialized with', Object.keys(this.domCache).length, 'elements');
		},
		...
		loadPatternLibraryIfNeeded: function() {
			...
			if (typeof masePatternLibrary !== 'undefined') {
				...
				if (typeof MASE.patternLibrary !== 'undefined' && typeof MASE.patternLibrary.init === 'function') {
