    ...
    var MASE = {
                    ...
                    error: function (xhr, status, error) {
                        ...
                        try {
                            ...
                            if (response && response.data && response.data.validation_errors) {
                                console.error('MASE: Validation errors:', response.data.validation_errors);
                                console.error('MASE: Error details:', response.data.error_details);
        ...
        init: function () {
            ...
            try {
                ...
                console.log('MASE: Checking livePreview availability...');
                console.log('MASE: this.livePreview exists?', !!this.livePreview);
                console.log('MASE: this.livePreview.bind type:', typeof this.livePreview.bind);
                ...
                if (this.livePreview && typeof this.livePreview.bind === 'function') {
                    ...
                    console.warn('MASE: livePreview object:', this.livePreview);
                }

                // Initialize responsive preview controls (Task 29 - Requirement 6.4)
                console.log('MASE: Checking initResponsivePreview availability...');
                console.log('MASE: this.livePreview.initResponsivePreview type:', typeof this.livePreview.initResponsivePreview);

                if (this.livePreview && typeof this.livePreview.initResponsivePreview === 'function') {
                    console.log('MASE: Initializing responsive preview');
